...
async function crearTablas() {
    ...
    // ASEGURAR COLUMNAS SI LA TABLA YA EXISTÍA DE ANTES
    try {
        await db.query(`ALTER TABLE ventas ADD COLUMN IF NOT EXISTS cliente VARCHAR(150) NOT NULL DEFAULT 'Cliente General'`);
        await db.query(`ALTER TABLE ventas ADD COLUMN IF NOT EXISTS cliente_fiado VARCHAR(150) NULL`);
        await db.query(`ALTER TABLE ventas ADD COLUMN IF NOT EXISTS estado_fiado VARCHAR(30) NULL DEFAULT NULL`);
    } catch (e) {
